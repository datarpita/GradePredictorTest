...
public class Input2 {
    ...
    public Input2 withColumnNames(List<String> columnNames) {
        this.columnNames = columnNames;
        return this;
    }
    ...
    public Input2 withValues(List<List<String>> values) {
        this.values = values;
        return this;
    }
    ...
    public Input2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Input2) == false) {
            return false;
        }
        Input2 rhs = ((Input2) other);
